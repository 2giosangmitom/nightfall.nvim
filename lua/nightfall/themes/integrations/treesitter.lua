...
function M.get(colors)
  ...
  local result = {
    ...
    ["@markup.raw"] = { fg = colors.turquoise, bg = colors.dark_navy },
    ["@markup.raw.markdown_inline"] = { fg = colors.turquoise, bg = colors.dark_navy },
    ["@markup.raw.block"] = { fg = colors.turquoise, bg = colors.dark_navy },
