...
function M.get(colors, options)
  ...
  return {
    ...
    Directory = { fg = accent },
    DiffAdd = { bg = utils.darken(colors.green, 0.5) },
    DiffChange = { bg = utils.darken(colors.blue, 0.4) },
    DiffDelete = { bg = utils.darken(colors.red, 0.5) },
    ...
    Title = { fg = accent },
    Visual = { bg = utils.lighten(colors.navy, 0.8, colors.azure), bold = true },
